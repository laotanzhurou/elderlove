...
def login(request, **kwargs):
    ...
    if request.method == "POST" and not url_required:
        ...
        if form.is_valid():
            ...
            account = Account.objects.get(user = form.user)
            if account.accounttype == "doctor":
                patientMgm.create_doctor_detail(form.user)
            elif account.accounttype == "patient":
                patientMgm.create_patient_detail(form.user)
